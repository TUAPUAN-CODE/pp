...
import ParentComponentChill5 from "./ParentComponentChill5";
import Buttom from "../../../Layout/Buttom";
const API_URL = import.meta.env.VITE_API_URL;


const  CSChill5PageCO = () => {
	...
	return (
		...
		>
		  ...
		  <Header title={"ห้อง Chill 5"}   />
		  </main>
		  <main className="max-w-8xl mx-auto py-1 px-1 lg:px-8">
		  <ParentComponentChill5  />
		  </main>
		  <main className="max-w-8xl mx-auto py-1 px-1 lg:px-8">
