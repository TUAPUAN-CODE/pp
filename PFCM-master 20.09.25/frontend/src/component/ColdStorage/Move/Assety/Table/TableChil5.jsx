...
const ParkingChil5 = ({ onSlotClick, tro_id }) => {
  ...
  // Function to format slot data (group by rows and columns)
  ...
  const fetchSlots = async () => {
    ...
    try {
      ...
      if (data.slot) {
        const slotData = data.slot.filter((item) => item.cs_id === 4 && item.slot_status);
