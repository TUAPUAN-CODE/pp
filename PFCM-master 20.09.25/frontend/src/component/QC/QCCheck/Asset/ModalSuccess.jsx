...
const ModalSuccess = ({ open, onClose, mat, mat_name, batch, production, rmfp_id, onSuccess,batch_after,level_eu }) => {
      ...
      >
        <DialogContent>
          <Typography variant="h6" style={{ fontSize: "18px", color: "#787878" }} mb={2}>
            กรุณาตรวจสอบข้อมูลก่อนทำรายการนะ
          </Typography>
  ...
  Level Eu (สำหรับปลา): {level_eu?.trim() || '-'}
</Typography>
