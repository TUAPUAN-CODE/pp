    ...
    <>
      {[...Array(rowsPerPage)].map((_, index) => (
        <TableRow key={index}>
          ...
          <TableCell align="center">
            <Skeleton animation="wave" height={32} width="50%" sx={{ mx: 'auto' }} />
          </TableCell>
          <TableCell align="center">
      ...
      <TableCell colSpan={3} align="center">
        <Fade in={true} timeout={800}>
          <Box sx={{ 
            ...
            <Inventory sx={{ fontSize: 48, color: theme.palette.text.secondary }} />
            <Typography variant="body1" color="text.secondary">
              ไม่พบข้อมูลเครื่องตรวจจับโลหะ
            </Typography>
          </Box>
        </Fade>
      </TableCell>
                  ...
                  >
                    <TableCell align="center">
                      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 1 }}>
                        <GiMechanicalArm 
                          fontSize="1.5rem" 
                          sx={{ color: item.Status === 1 ? BLUE_COLOR : 'text.disabled' }} 
                        />
                    ...
                    <TableCell align="center">
                      <Chip 
                        ...
                        label={item.Status === 1 ? "เปิดใช้งาน" : "ปิดใช้งาน"} 
                      ...
                      <Stack direction="row" spacing={1} justifyContent="center">
                        ...
                        <Tooltip title="ลบข้อมูล" arrow placement="top">
                          <IconButton 
                            size="small" 
                            color="error" 
                            onClick={() => handleDelete(item.md_no)}
                            sx={{ 
                              border: '1px solid',
