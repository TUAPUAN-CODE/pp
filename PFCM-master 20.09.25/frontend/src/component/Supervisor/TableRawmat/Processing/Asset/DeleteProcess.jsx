...
const DeleteProcess = ({ isOpen, onClose, onSuccess, processData }) => {
  ...
  return (
    <div className="modal-overlay" onClick={handleClose}>
      <div className="modal min-w-fit max-w-fit" onClick={(e) => e.stopPropagation()}>
        <div>
          <h1 className="text-rose-500 text-2xl">ลบกระบวนการ !!</h1>
          <p className="text-gray-700">
            คุณแน่ใจหรือไม่ว่าต้องการลบข้อมูลกระบวนการนี้?
          </p>
        </div>
        <div className="text-gray-500 p-2 my-5 border rounded-md">
          <p>รหัสกระบวนการ: {processId}</p>
          <p>ชื่อกระบวนการ: {processName}</p>
        </div>
