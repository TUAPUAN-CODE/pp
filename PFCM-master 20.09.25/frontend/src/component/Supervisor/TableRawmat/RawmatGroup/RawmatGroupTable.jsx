...
import TableMainRawmatGroup from "./Asset/MainRawmatGroup";
  ...
  return (
    ...
    >
      <main className="max-w-8xl mx-auto py-1 px-1 lg:px-8">
        <Header title="Raw Material Group Time Managemant | ตารางจัดการกลุ่มเวลาวัตถุดิบ" />
      </main>
      <main className="max-w-8xl mx-auto py-1 px-1 lg:px-8">
        <TableMainRawmatGroup/>
      </main>
      <main className="max-w-8xl mx-auto py-1 px-1 lg:px-8">
