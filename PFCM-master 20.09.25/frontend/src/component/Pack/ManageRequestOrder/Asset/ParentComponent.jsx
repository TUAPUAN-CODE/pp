...
const ParentComponent = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const response = await axios.get(`${API_URL}/api/pack/manage/order/fetchRM/${LineIdFromLocalStorage}`);
  ...
  const handleOpenEditModal = (data) => {
    const editData = {
      ...
      weight_per_tro: data.weight_per_tro,
      line_id:data.line_id,
      from_line_name:data.from_line_name,
      request_rm_id:data.request_rm_id,
