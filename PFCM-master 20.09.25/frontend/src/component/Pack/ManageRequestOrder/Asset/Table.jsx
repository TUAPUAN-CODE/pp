...
const TableMainPrep = ({
  ...
  const displayColumns = ['batch_after', 'mat', 'mat_name', 'production', 'weight_per_tro', 'level_eu','from_line_name'];
  ...
  const headerNames = {
    ...
    "weight_per_tro": "น้ำหนักวัตถุดิบ",
    "level_eu": "Level Eu",
    "from_line_name": "คำขอจากสายการผลิต"
  };
